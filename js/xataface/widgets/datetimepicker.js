...
//require <jquery.ui.datetimepicker.js>
//require-css <jquery.ui.datetimepicker.css>
...
(function(){
	...
	registerXatafaceDecorator(function(node){
		...
		$('input.xf-datetimepicker', node).each(function(){
			//alert($(this).attr('data-xf-date-format'));
			var self = this;
			
			var p = {
				dateFormat: ''+$(this).attr('data-xf-date-format'),
				altFormat: ''+$(this).attr('data-xf-date-format'),
				minuteInterval: parseInt($(this).attr('data-xf-time-interval'))
			};
